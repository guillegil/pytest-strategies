...
class TestConstraintIntegration:
    ...
    def test_rng_predicate_with_parameter(self):
        ...
        arg1 = TestArg("even", rng_type=RNGInteger(0, 100, predicate=lambda x: x % 2 == 0))
        arg2 = TestArg("odd", rng_type=RNGInteger(0, 100, predicate=lambda x: x % 2 == 1))
    ...
    def test_combined_predicates_and_constraints(self):
        ...
        # Even numbers only
        arg1 = TestArg("x", rng_type=RNGInteger(0, 50, predicate=lambda x: x % 2 == 0))
        # Odd numbers only
        arg2 = TestArg("y", rng_type=RNGInteger(0, 50, predicate=lambda x: x % 2 == 1))

        # Constraint: x + y < 60
        param = Parameter(arg1, arg2, vector_constraints=[lambda v: v[0] + v[1] < 60])
...
class TestWeightedRNGIntegration:
    ...
    def test_weighted_float_with_constraints(self):
        ...
        param = Parameter(arg1, arg2, vector_constraints=[lambda v: v[1] <= v[0] or v[1] >= 0.7])
...
class TestModeIntegration:
    ...
    def test_mixed_mode_integration(self):
        ...
        param_true = Parameter(
            arg, directed_vectors={"zero": (0,), "max": (100,)}, always_include_directed=True
        )
        ...
        param_false = Parameter(
            arg, directed_vectors={"zero": (0,), "max": (100,)}, always_include_directed=False
        )
...
class TestValidationIntegration:
    ...
    def test_multi_level_constraints(self):
        ...
        param = Parameter(arg1, arg2, vector_constraints=[lambda v: v[0] + v[1] <= 100])
